...
public class MindBiomeProvider extends BiomeProvider{
    ...
    private final Biome[] biomes = new Biome[]{ModWorld.FIELDS_REASON};

    public MindBiomeProvider(MindBiomeProviderSettings settingsProvider) {
        WorldInfo worldinfo = settingsProvider.getWorldInfo();
        MindGenSettings overworldgensettings = settingsProvider.getGeneratorSettings();
        Layer[] alayer = MindLayerUtil.buildOverworldProcedure(worldinfo.getSeed(), new MindWorldType(), overworldgensettings);
