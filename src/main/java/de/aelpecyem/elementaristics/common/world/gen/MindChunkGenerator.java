...
public class MindChunkGenerator extends NoiseChunkGenerator<MindGenSettings> {
    ...
    public MindChunkGenerator(IWorld world, BiomeProvider provider, MindGenSettings settingsIn) {
